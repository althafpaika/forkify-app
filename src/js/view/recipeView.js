...
class RecipeView extends View{
    ...
    _error_message = 'sorry.. couldn\'nt load the recipe for your query. \n pls try with another one'
    
    
    addHandlerRender(callback){
        ['hashchange','load'].forEach(event=>window.addEventListener(event,callback));
    }

    addHandlerServings(handler){
     this._parentEl.addEventListener('click',function(e){
          const btn = e.target.closest('.btn--handle-servings');
          if(!btn) return
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button data-serve-to='${this._data.servings - 1}' class="btn--tiny btn--handle-servings">
                <svg>
